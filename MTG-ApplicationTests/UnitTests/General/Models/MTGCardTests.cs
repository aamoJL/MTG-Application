...
namespace MTGApplicationTests.UnitTests.General.Models;
...
public class MTGCardTests
{
  ...
  {
    var allTypeLine = string.Join(' ', Enum.GetNames<SpellType>());
  ...
  [TestMethod(DisplayName = "Card cound should be the given value if the value is more than one")]
  ...
  [TestMethod(DisplayName = "Card cound should be the one if the value is less than one")]
