...
public class CardCollectionEditorViewModelTestBase
{
  ...
  public CardCollectionEditorViewModelTestBase()
    => _dependencies.ContextFactory.Populate(CardCollectionToDTOConverter.Convert(_savedCollection));

  internal class Mocker(CardCollectionRepositoryDependencies dependencies)
  {
