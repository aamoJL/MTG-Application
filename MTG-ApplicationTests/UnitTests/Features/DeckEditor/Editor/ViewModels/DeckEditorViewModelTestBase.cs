...
namespace MTGApplicationTests.UnitTests.Features.DeckEditor.Editor.ViewModels;

public abstract class DeckEditorViewModelTestBase
{
  ...
  public DeckEditorViewModelTestBase()
