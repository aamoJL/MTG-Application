...
[TestClass]
public class ImportCommander : DeckEditorViewModelTestBase
{
  [TestMethod(DisplayName = "Card should not change if the imported card is not legendary")]
  ...
  [TestMethod(DisplayName = "Card should change if the imported card is legendary")]
  ...
  [TestMethod(DisplayName = "Success notifications should be sent when the import was successfull")]
  ...
  [TestMethod(DisplayName = "Error notification should be sent when the import fails")]
