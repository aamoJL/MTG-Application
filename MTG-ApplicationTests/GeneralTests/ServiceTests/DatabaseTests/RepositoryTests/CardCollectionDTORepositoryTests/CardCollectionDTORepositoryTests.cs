...
namespace MTGApplicationTests.GeneralTests.ServiceTests.DatabaseTests.RepositoryTests.CardCollectionDTORepositoryTests;

[TestClass]
public class CardCollectionDTORepositoryTests
{
  ...
  public CardCollectionDTORepositoryTests() => _dependencies.ContextFactory.Populate(_savedCollection);
  ...
  public async Task Get()
  {
    ...
    Assert.AreEqual(_savedCollection.CollectionLists.Count, result.First().CollectionLists.Count);
  }
  ...
  public async Task Get_WithName()
  {
    ...
    Assert.AreEqual(_savedCollection.CollectionLists.Count, result.CollectionLists.Count);
  }
