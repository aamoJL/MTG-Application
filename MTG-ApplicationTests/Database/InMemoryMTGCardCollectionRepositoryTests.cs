...
namespace MTGApplicationTests.Database
{
  ...
  public class InMemoryMTGCardCollectionRepositoryTests 
  {
    ...
    {
      public TestInMemoryMTGCardCollectionRepository(ICardAPI<MTGCard>? cardAPI = default) : base(cardAPI)
      {
      ...
      public override async Task<bool> Remove(MTGCardCollection item)
      {
