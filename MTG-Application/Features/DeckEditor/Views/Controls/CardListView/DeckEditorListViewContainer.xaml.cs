...
public partial class DeckEditorListViewContainer : UserControl
{
  ...
  protected virtual async void OnDrop(object _, DragEventArgs e)
  {
  ...
  private void KeyboardAccelerator_Invoked(Microsoft.UI.Xaml.Input.KeyboardAccelerator _, Microsoft.UI.Xaml.Input.KeyboardAcceleratorInvokedEventArgs args)
  {
    if (args.Element is SelectableItemsRepeater sir)
    {
      if (sir.SelectedItem is not DeckEditorMTGCard selectedItem
        || sir.DataContext is not DeckCardListViewModel itemsViewViewModel
